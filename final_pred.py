...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="SILENT VOICE", font=("Courier", 30, "bold"))
    ...
    def speak_fun(self):
        import subprocess
        text = self.str.strip() or "Nothing to speak"
        # Use native Windows PowerShell TTS to completely bypass Python pyttsx3/COM/Threading bugs
        ps_command = f"Add-Type -AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak('{text}')"
        # Run completely detached so it doesn't block GUI at all
